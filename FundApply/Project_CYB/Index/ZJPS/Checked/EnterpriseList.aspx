<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnterpriseList.aspx.cs" Inherits="FundApply.Project_CYB.ZJPS.Checked.EnterpriseList" %>
    ...
    $(function () {
        $('#dg1').datagrid({
            ...
            data: {
                "total": 10, "rows":
                [
                                       { "applytype": "金融资金", "natorgcode": "MA001DEU2", "orgname": "北京商务中心区通信科技有限公司", "captial": 50.00, "status": "已核定", "applytime":"2017-04-21","yysr": 1000, "tax": 500, "industry": "金融业" }
                ]
            },
