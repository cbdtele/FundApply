<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnterpriseList.aspx.cs" Inherits="FundApply.Project_CYB.ZJPS.UnChecked.EnterpriseList" %>
    ...
    $(function () {
        $('#dg1').datagrid({
            ...
            data: {
                "total": 10, "rows":
                [
                                        { "applytype": "金融资金", "natorgcode": "MA001DEU2", "orgname": "北京商务中心区通信科技有限公司", "captialok": 200.00, "status": "未核定", "yysr": 1000, "tax": 500, "industry": "金融业" }
                ]
            },
