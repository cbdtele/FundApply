<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPublicity.aspx.cs" Inherits="FundApply.InformationManager.Publicity.EditPublicity" %>
...
<body>
    <div id="div_content" style="margin:20px 20px 20px 20px;">
        <form id="ff" method="post" runat="server">
            <table>
                <tr>
                    <td style="width: 1%;">政策名称：</td>
                    <td style="width: 10%;">
                        <input class="easyui-textbox" type="text" name="title" data-options="required:true" style="width: 50%;" value="政策名称测试"/>
        ...
        <div style="text-align: center; padding: 5px">
            ...
            <button class="button button-primary button-pill button-tiny" type="button" onclick="javascript:void(0);">取消</button>
        </div>
    </div>
</body>
</html>
<script type="text/javascript">
    $(function () {
        ...
        ue.ready(function () {
            var content = " 政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容";
