<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublicityDetails.aspx.cs" Inherits="FundApply.InformationManager.Publicity.PublicityDetails" %>
        ...
        <form id="ff" method="post" runat="server">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容
                            政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容
                            政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容政策测试内容
                        </label>
