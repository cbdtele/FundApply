<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPolicy.aspx.cs" Inherits="FundApply.InformationManager.Policy.EditPolicy" %>
        ...
        <form id="ff" method="post" runat="server">
            <table>
                <tr>
                    ...
                    <td style="width: 10%;">
                        <input class="easyui-textbox" type="text" name="title" data-options="required:true" style="width: 50%;" value="公示名称测试"/>
...
<script type="text/javascript">
    $(function () {
        ...
        ue.ready(function () {
            var content = " 公示测试内容公示测试内容公示测试内容公示测试内容公示测试内容公示测试内容公示测试内容公示测试内容公示测试内容公示测试内容公示测试内容公示测试内容公示测试内容公示测试内容公示测试内容公示测试内容公示测试内容公示测试内容公示测试内容公示测试内容公示测试内容";
