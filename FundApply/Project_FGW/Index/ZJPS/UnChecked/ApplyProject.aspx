<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyProject.aspx.cs" Inherits="FundApply.Project_FGW.Index.ZJPS.UnChecked.ApplyProject" %>
...
<body>
    <div style="padding: 2px 100px 5px 100px">
        <form class="layui-form" action="">
            ...
            <div class="layui-input-block">
                <input id="shzj" style="border-width:1px;margin-left:10px;"  type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入申请资金" class="layui-input" value="">
            </div>
        </form>
