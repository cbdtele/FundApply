<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditNotice.aspx.cs" Inherits="FundApply.Project_FGW.Notice.EditPolicy" %>
        ...
        <form id="ff" method="post" runat="server">
            <table>
                <tr>
                    ...
                    <td style="width: 10%;">
                        <input class="easyui-textbox" type="text" name="title" data-options="required:true" style="width: 50%;" value="测试标题test2"/>
