...
<body>
    ...
    <form class="layui-forma">
        ...
        <div style="text-align: center; padding: 5px">           
            <button class="button button-primary button-pill button-tiny" id="btnSubmit" lay-submit="" lay-filter="demo1" type="button">编辑提交</button>
...
<%--
    ...
    $("#btnSubmit").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<%=Request.Path%>/UpdateApplyProject",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: $data,
            success: function (r) {
